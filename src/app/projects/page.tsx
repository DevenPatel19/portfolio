...
const projects = [
  {
    ...
    description:
      "Full-stack mental wellness platform deployed to production with role-based access, therapist-patient management, and secure authentication. Features production deployment on Render.com with MongoDB Atlas cloud database.",
    technologies: [
      "React",
      "Node.js",
      "MongoDB",
  ...
  },
  {
    ...
    description:
      "Real-time analytics platform tracking Seattle's tech job market with live API data, interactive charts, and professional UI. Built with modern Next.js and TypeScript.",
  ...
  },
  {
    ...
    description:
      "A modern developer portfolio built with Next.js 15, featuring responsive design, smooth animations, and optimized performance. Showcasing full-stack development capabilities.",
  ...
  //   description:
  //     "Dynamic weather application that fetches live data using the OpenWeatherMap API and displays responsive forecasts with intuitive icons and detailed information. Note: This demo app is run locally without production deployment.",
...
export default function ProjectsPage() {
  ...
  return (
    <>
      {/* SEO Meta Tags */}
      <Head>
        <title>Deven Patel | Project Portfolio</title>
        <meta
          name="description"
          content="Explore production-ready full-stack projects by Deven Patel, built with React, Next.js, Node.js, MongoDB, TypeScript, and Tailwind CSS. Each project showcases real-world problem solving and production deployment."
        />
        <meta
          name="keywords"
          content="Full-Stack Developer, React, Next.js, Node.js, MongoDB, TypeScript, Tailwind CSS, Portfolio, Projects"
        />
        <meta name="author" content="Deven Patel" />

        {/* Open Graph / Social Sharing */}
        <meta property="og:title" content="Deven Patel | Project Portfolio" />
        <meta
          property="og:description"
          content="Explore production-ready full-stack projects by Deven Patel, showcasing real-world problem solving and production deployment."
        />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://portfolio-app-sigma-swart-49.vercel.app/projects" />
        <meta property="og:image" content="/project-screenshots/portfolio.png" />

        {/* Twitter Card */}
        <meta name="twitter:title" content="Deven Patel | Project Portfolio" />
        <meta
          name="twitter:description"
          content="Explore production-ready full-stack projects by Deven Patel, showcasing real-world problem solving and production deployment."
        />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:image" content="/project-screenshots/portfolio.png" />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Full-stack applications from concept to production deployment. Each project demonstrates real-world problem solving and technical execution.
            </p>
          </motion.div>
